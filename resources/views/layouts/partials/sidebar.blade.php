 <div class="navbar-header green darken-4" >
            <div class="d-flex">
                <!-- LOGO -->
                <div class="navbar-brand-box horizontal-logo">
                    <a href="/home" class="logo logo-dark">
                        <span class="logo-sm">
                            <img src="/images/logo/logo-bandes-mini.png" alt="" height="22">
                        </span>
                        <span class="logo-lg">
                            <img src="/images/logo/logo-bandes.png" alt="" height="17">
                        </span>
                    </a>

                    <a href="/home" class="logo logo-light">
                        <span class="logo-sm">
                            <img src="/assets/images/logo-bandes-mini.png" alt="" height="22">
                        </span>
                        <span class="logo-lg">
                            <img src="/images/logo/logo-bandes.png" alt="" height="30">
                        </span>
                    </a>
                </div>

                <button type="button" class="btn btn-sm px-3 fs-16 header-item vertical-menu-btn topnav-hamburger white-text" id="topnav-hamburger-icon">
                    ...
                    <div class="dropdown-menu dropdown-menu-lg" id="search-dropdown">
                        <div data-simplebar style="max-height: 320px;">
                            ...
                            <div class="dropdown-item bg-transparent text-wrap">
                                <a href="/home" class="btn btn-soft-primary btn-sm btn-rounded">how to setup <i class="mdi mdi-magnify ms-1"></i></a>
                                <a href="/home" class="btn btn-soft-primary btn-sm btn-rounded">buttons <i class="mdi mdi-magnify ms-1"></i></a>
                            </div>
                            <!-- item-->
               ...
               {{--  <div class="ms-1 header-item d-none d-sm-flex">
                ...
                <div class="dropdown topbar-head-dropdown ms-1 header-item ">
                    <button type="button" class="btn btn-icon btn-topbar btn-ghost-secondary rounded-circle" id="page-header-notifications-dropdown" data-bs-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
                        <i class='bx bx-bell fs-22 white-text'></i>
                ...
                <div class="dropdown ms-sm-3 header-item topbar-user green darken-4 white-text">
                    <button type="button" class="btn" id="page-header-user-dropdown" data-bs-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
                        <span class="d-flex align-items-center">
                            ...
                            <span class="text-start ms-xl-2">
                                <span class="d-none d-xl-inline-block ms-1 fw-medium user-name-text white-text">{{ \Auth::user()->name.' '.\Auth::user()->lastname   }}</span>
                                <span class="d-none d-xl-block ms-1 fs-12 text-muted user-name-sub-text white-text">{{ \Auth::user()->role->name }}</span>
                            </span>
                        </span>
                    </button>
                    <div class="dropdown-menu dropdown-menu-end">
                        <!-- item-->
                        <h6 class="dropdown-header">Bienvenido (a) {{ \Auth::user()->name.' '.\Auth::user()->lastname }}!</h6>
                        <a class="dropdown-item" href="{{ url('chat') }}"><i class="mdi mdi-chat text-muted fs-16 align-middle me-1"></i> <span class="align-middle">Chat en vivo</span></a>
                       ...
                       <a class="dropdown-item" href="{{ route('logout') }}"
                        ...
                        <i class="mdi mdi-logout text-muted fs-16 align-middle me-1"></i>   {{ __('Salir') }}
                        </a>
